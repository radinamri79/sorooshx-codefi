  ...
  return (
    <>
      ...
      <div className="pt-[100px] pb-6 sm:pb-8">
        <div className="mx-auto max-w-[1200px] 2xl:max-w-[1600px] px-6 sm:px-6 md:px-10">
          <nav
      ...
      <section className="w-full">
        <div className="mx-auto max-w-[1200px] 2xl:max-w-[1600px] px-6 sm:px-6 md:px-10 pb-6 sm:pb-8">
        <h1
      ...
      {/* Divider + Meta */}
      <section className="w-full">
        <div className="mx-auto max-w-[1200px] 2xl:max-w-[1600px] px-6 sm:px-6 md:px-10 pb-10 sm:pb-14">
          <hr
      ...
      <article className="w-full">
        <div className="mx-auto max-w-[1200px] 2xl:max-w-[1600px] px-6 sm:px-6 md:px-10 pb-16 sm:pb-24">
          <div
